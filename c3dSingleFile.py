...
def train_model(model,dataFrame,k,batch_size):
    #with h5py.File(videoData, "r") as video_data:
         ...
         for train_index, test_index in kf.split(sample_idxs ,groups=groups): #divide train and test in k different folds accroding to groups       
              ...
              checkpointer = ModelCheckpoint(filepath='/home/atilocca/deceptionDetection/weightsC3DbaselineSingleFile'+str(foldCount).zfill(3)+'.hdf5', verbose=1, save_best_only=True)
            ...
            #shuffle=True,  
              ...
              model.load_weights('/home/atilocca/deceptionDetection/weightsC3DbaselineSingleFile'+str(foldCount).zfill(3)+'.hdf5') 
